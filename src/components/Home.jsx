...
const Home = () => {
  return (
    <>
      <Box id="home" w={{base:"90%", md: "100%"}} maxW={"1350px"} m={"auto"} pt={{base: "6rem", md: "10rem"}}>
        <Flex
        ...
        >
          <Box>
            <Image
              ...
              display={"block"}
              margin={"auto"}
              _hover={{boxShadow: "rgba(200, 200, 200, 0.3) 0 0 15px 15px", transition: "box-shadow 0.3s ease-in-out"}}
